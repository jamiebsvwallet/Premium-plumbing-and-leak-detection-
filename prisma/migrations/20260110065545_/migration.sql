...
CREATE TABLE "Device" (
    ...
    "name" TEXT NOT NULL,
    "type" TEXT NOT NULL DEFAULT 'leak_sensor',
    "metadata" TEXT,
...
CREATE TABLE "Consent" (
    ...
    "scope" TEXT NOT NULL DEFAULT 'device_events',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
...
CREATE TABLE "BsvAnchor" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "BsvAnchor_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "DeviceEvent" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BsvAnchor_eventId_key" ON "BsvAnchor"("eventId");
